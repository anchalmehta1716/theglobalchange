...
```java
	...
	SlideMenuItem menuItem0 = new SlideMenuItem(ContentFragment.HOME, R.drawable.icn_close);
        list.add(menuItem0);
        SlideMenuItem menuItem = new SlideMenuItem(ContentFragment.ABOUTUS, R.drawable.icn_1);  \\first parameter is the id of menu item,the second is the icon resouce
        list.add(menuItem);
        SlideMenuItem menuItem2 = new SlideMenuItem(ContentFragment.LOGIN, R.drawable.icn_2);
        list.add(menuItem2);
